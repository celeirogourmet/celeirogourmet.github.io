...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log("Status pagamento:", payment.status, "Preference ID:", payment.preference_id);
    ...
    const updateResult = await sbFetch(`/rest/v1/Orders?preference_id=eq.${payment.preference_id}`, {
      method: "PATCH",
